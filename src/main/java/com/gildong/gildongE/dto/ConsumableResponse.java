...
public class ConsumableResponse {
    ...
    public String getEngineOilChangedDate() {
        return engineOilChangedDate;
    }

    public void setEngineOilChangedDate(String engineOilChangedDate) {
        this.engineOilChangedDate = engineOilChangedDate;
    }

    public String getBatteryChangedDate() {
        return batteryChangedDate;
    }

    public void setBatteryChangedDate(String batteryChangedDate) {
        this.batteryChangedDate = batteryChangedDate;
    }

    public String getCoolantChangedDate() {
        return coolantChangedDate;
    }

    public void setCoolantChangedDate(String coolantChangedDate) {
        this.coolantChangedDate = coolantChangedDate;
    }

    public String getTransmissionOilChangedDate() {
        return transmissionOilChangedDate;
    }

    public void setTransmissionOilChangedDate(String transmissionOilChangedDate) {
        this.transmissionOilChangedDate = transmissionOilChangedDate;
    }

    public String getBrakeOilChangedDate() {
        return brakeOilChangedDate;
    }

    public void setBrakeOilChangedDate(String brakeOilChangedDate) {
        this.brakeOilChangedDate = brakeOilChangedDate;
    }

    public String getAirconFilterChangedDate() {
        return airconFilterChangedDate;
    }

    public void setAirconFilterChangedDate(String airconFilterChangedDate) {
        this.airconFilterChangedDate = airconFilterChangedDate;
    }
    public String getId() {
        return id;
    }
